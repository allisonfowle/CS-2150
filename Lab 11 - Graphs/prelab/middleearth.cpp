 ...
 * 
 * @return void
 * @param x iterator of a vector of strings for "first"
 * @param y iterator of a vector of strings for "last"
 * @param z reference
 */
...
/**
 * @brief Prints out the array of cities with coordinates
 * 
 * @return void
 */
...
/**
 * @brief Print out a table with location and positions
 * 
 * @return void
 */
...
/**
 * @brief The first city is the original start point as well as the end point.
 * 
