...
private:
    ...
    void myInsert(const string& x, AVLNode *& curNode);
    bool myFind(const string& x, AVLNode * curNode) const;
    string myPathTo(const string& x, AVLNode * curNode) const;
    int myNumNodes(AVLNode * curNode) const;
